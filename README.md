...
[![MCP](https://img.shields.io/badge/MCP-29_tools-blue?logo=anthropic)](https://modelcontextprotocol.io)
...
### MCP Server (29 tools for structured agent calls)
...
> You have access to scomp-link, an ML toolkit with 29 MCP tools. Use them for:
