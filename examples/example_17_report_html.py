...
from scomp_link.utils.plotly_utils import area_chart, barchart, histogram, linechart, multiple_histograms
...
figures_dict = {"UAT": fig1, "PROD": fig2}
...
demo_report.add_many_plots_with_selection_box_to_report(figures_dict, "My fourth Graph", labels=["Number", "Color"])
