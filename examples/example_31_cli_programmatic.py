...
from scomp_link.utils.decorators import suppress_exceptions, timer
...
if __name__ == "__main__":
    ...
    try:
        ...
        results["predict"] = run_cli_command(
            "predict",
            [
                "predict",
                "--artifact",
        ...
        results["quality"] = run_cli_command(
            "quality",
            [
                "quality",
                "--data",
        ...
        results["engineer"] = run_cli_command(
            "engineer",
            [
                "engineer",
                "--data",
        ...
        results["anomaly"] = run_cli_command(
            "anomaly",
            [
                "anomaly",
                "--data",
        ...
        results["fairness"] = run_cli_command(
            "fairness",
            [
                "fairness",
                "--data",
        ...
        results["forecast"] = run_cli_command(
            "forecast",
            [
                "forecast",
                "--data",
        ...
        results["compare"] = run_cli_command(
            "compare",
            [
                "compare",
                "--artifacts",
        ...
        results["report"] = run_cli_command(
            "report",
            [
                "report",
                "--data",
