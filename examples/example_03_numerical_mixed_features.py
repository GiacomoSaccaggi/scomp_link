...
df["loan_amount"] = df["income"] * 3 + df["credit_score"] * 100 + df["age"] * 1000 + np.random.normal(0, 10000, n)
...
pipe.choose_model("numerical_prediction", metadata={"only_numerical_exogenous": False, "all_variables_important": True})
...
models_to_test = {
    ...
    "RandomForest": {
        ...
        "params_grid": {"n_estimators": [100, 200], "max_depth": [10, 20, None]},
    },
}
