...
df["target"] = 1.5 * df["feature_1"] + 2 * df["feature_2"] - 0.5 * df["feature_3"] + np.random.randn(n) * 0.3
...
pipe.choose_model("numerical_prediction", metadata={"only_numerical_exogenous": True, "all_variables_important": True})
