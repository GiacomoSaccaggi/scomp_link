...
from scomp_link.models.advanced_tuning import EarlyStoppingCV, HalvingSearchOptimizer, OptunaOptimizer
...
optimizer = OptunaOptimizer(GradientBoostingRegressor, param_space, scoring="r2", n_trials=30, cv=5)
