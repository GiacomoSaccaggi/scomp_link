...
Compatible with Claude Desktop, Kiro, Cursor, VS Code Copilot. Exposes 33 tools, 3 resources, and 4 prompts. See [Agent Integration](agent-integration.md) for setup.
