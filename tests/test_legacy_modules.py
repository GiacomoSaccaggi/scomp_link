...
class TestClassifierOptimizer:
    ...
    def classification_setup(self):
        ...
        models = {
            "LogisticRegression": {"model": LogisticRegression(max_iter=200), "params_grid": {"C": [0.1, 1.0]}},
            "RandomForest": {"model": RandomForestClassifier(n_estimators=10), "params_grid": {"max_depth": [3, 5]}},
        }
        return df, models
...
@pytest.mark.skipif(not _can_reach_huggingface(), reason="HuggingFace Hub unreachable (no network or blocked in CI)")
