...
from scomp_link import ModelFactory, Preprocessor, ScompLinkPipeline, Validator
...
@pytest.fixture
def small_data():
    return pd.DataFrame({"x1": np.random.randn(50), "x2": np.random.randn(50), "y": np.random.randn(50)})
