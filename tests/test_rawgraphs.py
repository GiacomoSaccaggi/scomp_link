...
class TestTimeSeries:
    ...
    def test_gantt_chart(self):
        ...
        tasks = [
            {"name": "T1", "start": 0, "end": 3, "group": "P1"},
...
class TestCorrelations:
    ...
    def test_contour_plot(self):
        ...
        np.random.seed(0)
        svg = contour_plot(np.random.normal(0, 1, 50).tolist(), np.random.normal(0, 1, 50).tolist(), "Test")
        assert "<svg" in svg
    ...
    def test_hexagonal_binning(self):
        ...
        np.random.seed(0)
        svg = hexagonal_binning(np.random.normal(0, 1, 100).tolist(), np.random.normal(0, 1, 100).tolist(), "Test")
        assert "<svg" in svg
...
class TestNetworks:
    ...
    def test_alluvial_diagram(self):
        ...
        flows = [{"source": "A", "target": "X", "value": 10}, {"source": "B", "target": "Y", "value": 5}]
