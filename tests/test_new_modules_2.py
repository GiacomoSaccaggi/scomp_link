...
class TestFeatureEngineer:
        ...
        X = pd.DataFrame(
            {
                ...
                "city": np.random.choice(
                    ["NYC", "LA", "CHI", "HOU", "PHX", "PHI", "SA", "SD", "DAL", "SJ", "AUS", "JAX"], 200
                ),
            }
        )
    ...
    def test_log_transform_skewed(self, sample_data):
        ...
        X, y = sample_data
        fe = FeatureEngineer(
            interactions=False, log_transform=True, date_features=False, target_encode=False, auto_bin=False
        )
    ...
    def test_interactions(self, sample_data):
        ...
        fe = FeatureEngineer(
            interactions=True, log_transform=False, date_features=False, target_encode=False, auto_bin=False
        )
    ...
    def test_date_features(self):
        ...
        fe = FeatureEngineer(
            interactions=False, log_transform=False, date_features=True, target_encode=False, auto_bin=False
        )
    ...
    def test_auto_bin(self, sample_data):
        ...
        X_num = X[["income", "age"]]
        fe = FeatureEngineer(
            interactions=False, log_transform=False, date_features=False, target_encode=False, auto_bin=True, n_bins=4
        )
        X_eng = fe.fit_transform(X_num, y)
    ...
    def test_sklearn_compatible(self, sample_data):
        ...
        X_num = X[["income", "age"]]
        fe = FeatureEngineer(
            interactions=False, log_transform=True, auto_bin=False, date_features=False, target_encode=False
        )
        fe.fit(X_num, y)
