...
class AdvancedCV:
    ...
    def bootstrap(model, X, y, n_iterations=1000, test_size=0.3, random_state=42):
        ...
        for i in range(n_iterations):
            ...
            train_idx = rng.choice(n_samples, size=n_samples - n_test, replace=True).tolist()
    ...
    @staticmethod
    def evaluate_all(model, X, y, include_loocv=True, include_bootstrap=True, bootstrap_iterations=1000, scoring=None):
        """
