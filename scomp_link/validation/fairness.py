...
class FairnessMetrics:
    ...
    def __init__(self, y_true, y_pred, sensitive_feature, positive_label: int = 1):
    ...
    def disparate_impact(self) -> Dict:
        ...
        return {"rates": rates, "di_ratios": di_ratios, "di_ratio": min_ratio, "four_fifths_rule": min_ratio >= 0.8}
        ...
        rows = [
            {
                ...
                "value": report["demographic_parity"]["dp_ratio"],
                "threshold": "≥ 0.8",
                "fair": report["demographic_parity"]["fair"],
            },
            {
                "metric": "Disparate Impact (4/5 rule)",
                "value": report["disparate_impact"]["di_ratio"],
                "threshold": "≥ 0.8",
                "fair": report["disparate_impact"]["four_fifths_rule"],
            },
            {
                "metric": "Equal Opportunity (TPR diff)",
                "value": report["equal_opportunity"]["tpr_diff"],
                "threshold": "< 0.1",
                "fair": report["equal_opportunity"]["fair"],
            },
            {
                "metric": "Equalized Odds (TPR diff)",
                "value": report["equalized_odds"]["tpr_diff"],
                "threshold": "< 0.1",
                "fair": report["equalized_odds"]["fair"],
            },
            {
                "metric": "Equalized Odds (FPR diff)",
                "value": report["equalized_odds"]["fpr_diff"],
                "threshold": "< 0.1",
                "fair": report["equalized_odds"]["fair"],
            },
        ]
    ...
    def plot_fairness_report(self, report: Optional[Dict] = None):
        ...
        fig.update_layout(barmode="group", title="Fairness Metrics by Group", yaxis_title="Rate", xaxis_title="Group")
        fig.add_hline(y=0.8, line_dash="dash", line_color="orange", annotation_text="4/5 threshold")
        return fig
