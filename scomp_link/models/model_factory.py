...
from sklearn.linear_model import ElasticNet, Lasso, LogisticRegression, Ridge, SGDClassifier, SGDRegressor
...
from .regressor_optimizer import Boruta, RegressorOptimizer
    ...
    def get_model(model_type: str, **kwargs):
        ...
        if "Contrastive Text" in model_type or "Contrastive Learning" in model_type:
            try:
                ...
                from .supervised_text import SpacyEmbeddingModel as FallbackModel

                return FallbackModel(**kwargs)  # Fallback
            ...
            try:
                from .unsupervised_text import UnsupervisedTextClusterer  # type: ignore[attr-defined]

                return UnsupervisedTextClusterer(**kwargs)
            except (ImportError, AttributeError):
                logger.info("⚠️ UnsupervisedTextClusterer not available")
                return None
        ...
        # Classification
            ...
            return SVC(probability=True)  # pyright: ignore[reportArgumentType]
